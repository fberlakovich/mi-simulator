 ...
 *
 */
public class Exts extends Command {
     ...
     */
    public Exts(Machine machine, int line, int adress, Operand op1, Operand op2, Operand op3, Operand op4,
                int beg, int end) {
    ...
    /**
     * Decodes an EXTS instruction from memory.
     * MI Manual page 93: EXTS with 4 operands (extract bitfield, sign extend).
     * Opcode: 0xF6
     */
    ...
    public String toString() {
        ...
        return "EXTS " + op1.toString() + ", " + op2.toString() + ", " + op3.toString()
                + ", " + op4.toString();
    }
}
