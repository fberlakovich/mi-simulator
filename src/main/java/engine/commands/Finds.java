...
public class Finds extends Command {
    ...
    public synchronized void run() {
        ...
        // 2-operand: FINDS source, dest - find first set bit (LSB-0 numbering)
        // 4-operand: FINDS P, S, A, dest - search S bits starting at P from A (MSB-0)
        ...
        if (op3 == null) {
            ...
            // Find the lowest set bit (LSB-0 numbering)
            ...
            machine.getFlags().setZero(result == -1);  // Z=1 if bit not found
    ...
    public String toString() {
        return "FINDS " + op1.toString() + ", " + op2.toString() + ", " + op3.toString() + ", " + op4.toString();
    }
}
