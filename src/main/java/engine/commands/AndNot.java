...
public class AndNot extends Command {
     ...
     */
    public AndNot(Machine machine, int line, int adress, int length, Operand op1, Operand op2, int beg,
                  int end) {
     ...
     *            the end
     */
    public AndNot(Machine machine, int line, int adress, int length, Operand op1, Operand op2, Operand op3,
                  int beg, int end) {
    ...
    /**
     * Decodes an ANDNOT instruction from memory.
     * MI Manual page 91: ANDNOT B/H/W with 2 or 3 operands.
     * Opcodes: 0xB3-0xB8
     */
    public static Command decode(Machine machine, int pc, Opcode opcode) {
        ...
        if (opcode.operandCount == 3) {
            ...
            return new AndNot(machine, 0, pc, opcode.length, op1, op2, op3, 0, 0);
        }
    ...
    public String toString() {
        ...
        return "ANDNOT " + bhwfd + " " + op1.toString() + ", " + op2.toString() + (three ?
                ", " + op3.toString() :
                "");
    }
